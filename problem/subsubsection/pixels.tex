...
\begin{enumerate}
  ...
  \item create pixel - opretter en pixel af typen Pixel med en RGB-værdi.
  \item pixel component to byte – ændrer værdien af RGB fra at være mellem 0 og 1, til at være mellem 0 og 255.
  \item pixel scale - skalerer en given pixel.
  \item pixel multiply - ganger to pixels sammen, der bruges til colorblending og udregning af, hvor meget farve der optages ift. 					     intensitet.
  \item pixel add - adderer to pixels, for at kunne udregne gennemsnittet senere (eller hvad???????????).
