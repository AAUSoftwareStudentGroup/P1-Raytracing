...
Funktionen raytracer\_triangle\_intersection bruges til at tjekke om der er skæring mellem en stråle og en trekant. Funktionen ses herunder
...
Funktionen finder en normaliseret normalvektor ud fra to vektorer som beskriver siderne i trekanten (linje 7). Derefter findes trekantens plan ud fra en stedvektor og en normalvektor (linje 10). Der tjekkes nu om der er skæring mellem trekant og plan (linje 13), hvis der er skæring tjekkes der om punktet ligger i trekanten (linje 13 - 22). Hvis punktet ligger indenfor trekanten (linje 22) så skaleres der med -1 for, at få normalvektoren til trekanten til at vende ud mod kameraet (linje 23) og værdien gemmes (linje 24).
