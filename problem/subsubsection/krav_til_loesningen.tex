...
\begin{enumerate}
    \item Programmet skal kunne implementeres på en hjemmeside.
    \item Skal kunne visualisere billedet relativt hurtigt, da kunderne ikke skal vente før de kan se billedet.
    \item Programmet skal kunne modtage et vilkårligt billede (i den rigtige format) og rendere \ref{sec:Fra_model_til_billede} dette.
    \item Lysets udbredelse skal kunne ses tydeligt af kunden.
