...
\begin{subfigure}{.5\textwidth}
  \centering
  \begin{tikzpicture}
\path[draw=black] (-3,-2.5) -- (-3,2.5) -- (3.5,2.5) -- (3.5,-2.5) -- (-3,-2.5);
\path[draw=black] (-2.5, 1.0) -- (-2.5,1.5) -- (3,1.5) -- (3,1.0) -- (-2.5,1.0);
\path[draw=black] (-2.5, -2.0) -- (-2.5,0.5) -- (-1.5,0.5) -- (-1.5,-2.0) -- (-2.5,-2.0);
\foreach \x in {0,1,2}
{
\foreach \y in {0,1}
{
\path[draw=black] (\x * 1.5 - 1.0, -\y * 1.5 - 0.5) -- (\x * 1.5 - 1.0,-\y * 1.5 + 0.5) -- (\x * 1.5, -\y * 1.5 + 0.5) -- (\x * 1.5,-\y * 1.5 - 0.5) -- (\x * 1.5 - 1.0, -\y * 1.5 - 0.5);
}
}
\path[draw=black, fill=white] (- 1.0, 0.5 - 0.33) -- (- 1.0, 0.5) -- (- 1.0 + 0.33, 0.5) -- (- 1.0 + 0.33, 0.5- 0.33) -- (- 1.0, 0.5 - 0.33);
\end{tikzpicture}
  \caption{A subfigure}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \begin{tikzpicture}
\path[draw=black] (-3,-2.5) -- (-3,2.5) -- (3,2.5) -- (3,-2.5) -- (-3,-2.5);
\path[draw=black] (-2.5, 1.0) -- (-2.5,1.5) -- (2.5,1.5) -- (2.5,1.0) -- (-2.5,1.0);
\path[draw=black] (-2.5, -2.0) -- (-2.5,0.5) -- (-1.5,0.5) -- (-1.5,-2.0) -- (-2.5,-2.0);
