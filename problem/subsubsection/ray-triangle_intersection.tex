...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[tdplot_main_coords,thick,scale=2]
    ...
    \node [above] at (1,-3.3,2.1) {$\vv{AB \times AC}$};
    \node [above] at (1.9,-3.5,3.05) {$\vv{AB \times AP}$};
    \node [above] at (1.9,-4.3,3.05) {$\vv{AB \times AP'}$};
