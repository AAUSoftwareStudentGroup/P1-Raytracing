...
\begin{enumerate}
    ...
    \item Ved brug af raytracing kunne fremstille et billede på baggrund af bruger inputtet. Derudover skal raytracerens renderingstid optimeres ved brug af KD-træer.
    \item Gemme det renderede billede.
\end{enumerate}