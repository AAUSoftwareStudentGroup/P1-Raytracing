...
\begin{enumerate}
  ...
  \item vector dot – prikker to vektorer sammen (resultat bruges i vector_norm og vector angle between).
  ...
  \item vector angle_between – finder vinklen mellem to vektorer.
  \item vector cross – Udregner krydsproduktet og finder dermed normalvektoren.
  \item vector rotate_around_z og vector_rotate_around_x – roterer en given vektor omkring hhv. z- eller x-aksen.
