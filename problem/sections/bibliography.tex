...
\bibitem{farvetemp}
  Beskrivelse af farvetemperatur, Den Store Danske, set 13-12-2015,
  \url{http://www.denstoredanske.dk/It,_teknik_og_naturvidenskab/Elektricitet/Belysning/farvetemperatur}
  
\bibitem{solidworks}
  Liste af solidworks produkter, solidworks, set 13-12-2015,
...
\bibitem{artemides}
  Artemides Augmented Reality App, set 14-12-2015,
