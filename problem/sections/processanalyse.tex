...
Her er et par eksempler på brainstorms fra starten af projektet:
...
\end{itemize}
Her ses en typisk dagsorden for starten af projektet, hvor vi brugte lang tid på at diskutere hvilket emne vi ville arbejde med, samt at få styr på praktiske ting som programmer
til fildeling.

Et andet eksempel på en dagsorden kunne se sålede ud:
\paragraph{Dagsorden 20/10/15:}
\begin{itemize}
  \item Hvor er fokus?
  \item Status til problemanalyse.
  \item Vejledermøde.
  \item HV-spørgsmål.
\end{itemize}
Denne dagsorden illustrere nogle af de diskussioner som vi foretog os i forbindelse med udarbejdelsen af problemanalysen

Hvis vi går hen til efter problemformuleringen hvor vi arbejdede med at lave en løsning så var dagsorden ofte således:d 

\paragraph{Dagsorden 20/11/15:}
\begin{itemize}
  \item Begynd med programmet heraf at kode.
  \item Undersøge forskellige filformater.
  \item Find indformationer om phong-shading.
\end{itemize}
Her var der ofte fokus på at blande teori med programskrivning, hvilken vil sige, at vi benyttede os af den fundne teori til at skrive vores program
