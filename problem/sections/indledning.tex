...
Rapportstrukturen afspejlder den metodiske tilgang til projektet. Rapportens afsnit er struktureret i kronologisk rækkefølge fra indledning til konklusionen (punkt 1 -6). 
...
\item Problemanalyse: En analyse af problemfeltet for at få en dybere forståelse for det initierende problem. Afsnittet indeholder følgende underafsnit:
  \begin{itemize}
    ...
    \item Interessentanalyse: Undersøger interessenterne og hvilken målgruppe rapporten vil arbejde videre med. I afsnittet har gruppen anvendt den kvalitative undersøgelse til bla.\ at samarbejde med erhvervslivet heraf designere, lamebutikker og belysningskonsulenter se bilag \ref{sec_bilag}. Formålet med interessentanalysen er at finde ud af hvilke interessenter som denne rapport vil løse problemet for.
