...
\item Diskussion: Diskuterer resultaterne og udarbejdelsen af rapporten. Afsnittet indeholder følgende underafsnit:
  \begin{itemize}
    ...
    \item Diskussion af det initierende problem: Diskuterer de valg og samt antagelser som blev foretaget i forbindelse med udarbejdelsen af problemformuleringen.
  \end{itemize}
